...
GlobalDecoderRegistry.registerAminoProtoMapping(
  InternalGaugeInfo.aminoType,
  InternalGaugeInfo.typeUrl
)
...
GlobalDecoderRegistry.registerAminoProtoMapping(
  GroupsWithGauge.aminoType,
  GroupsWithGauge.typeUrl
)
